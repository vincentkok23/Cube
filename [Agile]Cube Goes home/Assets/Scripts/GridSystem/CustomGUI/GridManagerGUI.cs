...
public class GridManagerGUI : Editor
{
    ...
    private void SetFieldCondition()
    {
        ...
        ShowOnEnum("GRID_TYPE", "EDITOR", "Width"); //type1Var is only visible when type == Type1
        ShowOnEnum("GRID_TYPE", "EDITOR", "Height");

        //only visible in TILEDATA mode
        ShowOnEnum("GRID_TYPE", "TILEDATA", "TileData"); //type2Var is only visible when type == Type2

        //visible in both modes! <NOT WORKING>
        /*ShowOnEnum("GRID_TYPE", "EDITOR", "Block_Size");
        ShowOnEnum("GRID_TYPE", "TILEDATA", "Block_Size");
        ShowOnEnum("GRID_TYPE", "EDITOR", "Centered");
        ShowOnEnum("GRID_TYPE", "TILEDATA", "Centered");
        ShowOnEnum("GRID_TYPE", "EDITOR", "Parent");
        ShowOnEnum("GRID_TYPE", "TILEDATA", "Parent");
        ShowOnEnum("GRID_TYPE", "EDITOR", "debug_text");
        ShowOnEnum("GRID_TYPE", "TILEDATA", "debug_text");
        ShowOnEnum("GRID_TYPE", "EDITOR", "debug_logs");
        ShowOnEnum("GRID_TYPE", "TILEDATA", "debug_logs");*/
